...
app.nextLevel = function () {
    if (questionCount == winner){
        $("main").empty().addClass("addBalloons").append(`<h3>Winner!!!</h3><div class="balloonDiv"><svg class="sausage-dog-animation" xmlns="http://www.w3.org/2000/svg" viewBox="-50 0 1200 1080">
