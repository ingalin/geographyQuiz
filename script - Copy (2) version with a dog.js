...
// This part of the code is from https://codepen.io/stivaliserna/pen/jObPyKe for animation for a winner
app.winnerFunction = function () {
    if (questionCount == winner) {
        $("main").empty().append(`<div class="addAnimationWinner"><h3>Winner!!!</h3><div class="winnerAnimationDiv"><svg class="sausage-dog-animation" xmlns="http://www.w3.org/2000/svg" viewBox="-50 0 1200 1080">
    <ellipse class="shadowDog" ry="45" rx="350" cy="816" cx="498" opacity="1" fill="#B2CAE8" fill-opacity="1" stroke="#B2CAE8" stroke-width="4" />
